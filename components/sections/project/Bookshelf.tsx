...
export default function Bookshelf({ 
  ...
  // Desktop layout - bookshelf and panel side by side
  if (layout === 'desktop') {
    return (
      <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem', width: '100%' }}>
        <p className="font-pixel" style={{ fontSize: '0.5rem', color: 'var(--text3)', letterSpacing: 0, lineHeight: 1 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'flex-start', gap: '2rem', flexWrap: 'wrap' }}>
          ...
          {/* Project panel - side by side on desktop */}
          {activeProject && (
  ...
  // Mobile layout - bookshelf above, panel below
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', width: '100%' }}>
      <p className="font-pixel" style={{ fontSize: 'clamp(0.4rem, 3vw, 0.5rem)', color: 'var(--text3)', letterSpacing: 0, lineHeight: 1 }}>
        {'// click a book to open it'}
      </p>

      {/* Bookshelf - scrollable on mobile */}
      <div style={{ 
        display: 'flex', 
        ...
        <div style={{ display: 'flex', flexDirection: 'column', flexShrink: 0 }}>
          <div
            ...
            style={{
              ...
              padding: 'clamp(6px, 2vw, 10px) clamp(8px, 3vw, 14px) 0',
              background: 'var(--wood)',
              borderTop: '2px solid var(--wood3)',
              borderLeft: '2px solid var(--wood3)',
              borderRight: '2px solid var(--wood3)',
  ...
  return (
    <div
      ...
      style={{
        ...
        height: 'fit-content',
        maxHeight: 'clamp(350px, 50vh, 400px)',
        overflowY: 'auto',
        width: '100%',
      }}
    >
      <div style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'space-between', flexWrap: 'wrap', gap: '0.5rem' }}>
        <h3 className="font-pixel" style={{ fontSize: 'clamp(0.5rem, 2.5vw, 0.6rem)', color: 'var(--amber)', letterSpacing: 0, lineHeight: 1.6 }}>
          {project.title}
        </h3>
        <span className="font-pixel" style={{ fontSize: 'clamp(0.4rem, 2vw, 0.5rem)', color: 'var(--text3)', letterSpacing: 0, lineHeight: 1 }}>
          {project.year}
        </span>
      </div>
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.4rem' }}>
        {project.tags.map((tag) => (
          <span key={tag} className="skill-tag" style={{
            fontSize: 'clamp(0.35rem, 2vw, 0.45rem)',
            whiteSpace: 'normal',
            wordBreak: 'break-word',
          }}>{tag}</span>
        ))}
      ...
      <div style={{ display: 'flex', gap: '0.75rem', flexWrap: 'wrap', marginTop: '0.25rem' }}>
        {project.github ? (
          <a href={project.github} target="_blank" rel="noopener noreferrer" className="btn-pixel btn-pixel--wood" style={{
            fontSize: 'clamp(0.4rem, 2vw, 0.45rem)',
          ...
          <span className="btn-pixel font-pixel" style={{
        ...
        {project.demo && (
          <a href={project.demo} target="_blank" rel="noopener noreferrer" className="btn-pixel btn-pixel--blue" style={{
            fontSize: 'clamp(0.4rem, 2vw, 0.45rem)',
            padding: 'clamp(0.4rem, 2vw, 0.5rem) clamp(0.6rem, 3vw, 0.75rem)',
            whiteSpace: 'nowrap',
          }}>
